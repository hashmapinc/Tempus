...
public class MqttTopics {
    ...
    public static final String SP_DEVICE_TELEMETRY_TOPIC = "spBv1.0/" + BASE_DEVICE_API_TOPIC + "/telemetry";
    ...
    public static final String GATEWAY_DEPTH_TELEMETRY_TOPIC = BASE_GATEWAY_API_TOPIC + "/depth/telemetry";
