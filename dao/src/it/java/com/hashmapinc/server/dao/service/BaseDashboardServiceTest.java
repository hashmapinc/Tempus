...
public abstract class BaseDashboardServiceTest extends AbstractServiceTest {
    ...
    public void testFetchByDataModelObjectId() {
        ...
        DataModelObjectId dataModelObjectId = dashboard.getAssetLandingInfo().getDataModelObjectId();
    ...
    private Dashboard CreateDashboard() {
        ...
        AssetLandingInfo assetLandingInfo = new AssetLandingInfo();

        assetLandingInfo.setDashboardId(dashboardId);
        DataModelId dataModelId = new DataModelId(UUIDs.timeBased());
        assetLandingInfo.setDataModelId(dataModelId);
        DataModelObjectId dataModelObjectId = new DataModelObjectId(UUIDs.timeBased());
        assetLandingInfo.setDataModelObjectId(dataModelObjectId);

        dashboard.setAssetLandingInfo(assetLandingInfo);
        return  dashboard;
    }
