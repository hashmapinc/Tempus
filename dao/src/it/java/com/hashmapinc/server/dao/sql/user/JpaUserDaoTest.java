...
public class JpaUserDaoTest extends AbstractJpaDaoTest {
    ...
    public void testFindByEmail() {
        User user = userDao.findByEmail("sysadm@tempus.org");
    ...
    public void testSave() throws IOException {
        ...
        User savedUser = userDao.findByEmail("user@tempus.org");
    ...
    private void saveUser(UUID tenantId, UUID customerId) {
        ...
        String email = idString.substring(0, idString.indexOf('-')) + "@tempus.org";
        user.setEmail(email);
        userDao.save(user);
    }
}
