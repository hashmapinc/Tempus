...
public class ConfigurationJsonCodec extends JacksonJsonCodec<ComputationJobConfiguration> {

    public ConfigurationJsonCodec() {
        super(ComputationJobConfiguration.class);
    }
}
