...
public class SnsTopicActionMsg extends AbstractRuleToPluginMsg<SnsTopicActionPayload> {
    ...
    @JsonCreator
    private SnsTopicActionMsg(@JsonProperty("uid") UUID id,
                              ...
                              @JsonProperty("payload") SnsTopicActionPayload payload,
    ...
    public RuleToPluginMsg<SnsTopicActionPayload> copyDeliveryId(Long deliveryId) {
        return new SnsTopicActionMsg(this.getUid(), this.getTenantId(), this.getCustomerId(),
