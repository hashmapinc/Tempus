 ...
 */
public class KinesisFirehoseAsyncFactory {

    private KinesisFirehoseAsyncFactory() {}

    public static final KinesisFirehoseAsyncFactory INSTANCE = new KinesisFirehoseAsyncFactory();
