...
/**
 * 
 * @param XYZs - array of 1 or more XYZ objects containing coordinates to plot
 */
export function plot(XYZs) {
  // get data
  var data = XYZs.map(xyz => {
    return {
      x: xyz.x,
      y: xyz.y,
      z: xyz.z,
 ...
 * 
 * @param $container - jquery object holding the widget container
 */
...
/**
 * this function instantiates the widget
 * 
 * @param widgetContext - context of the widget from tempus
 */
