    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "application": {
                    ...
                    "add": "Add Application",
                    "assign-application-to-customer": "Assign Application(s) To Customer",
                    "assign-application-to-customer-text": "Please select the applications to assign to the customer",
                    "assign-to-customer-text": "Please select the customer to assign the application(s)",
                    "assign-to-customer": "Assign to customer",
                    "unassign-from-customer": "Unassign from customer",
                    ...
                    "assign-applications-text": "Assign { count, select, 1 {1 application} other {# applications} } to customer",
                    "delete-applications": "Delete applications",
                    "unassign-applications": "Unassign applications",
                    "unassign-applications-action-title": "Unassign { count, select, 1 {1 application} other {# applications} } from customer",
                    ...
                    "unassign-application-text": "After the confirmation the application will be unassigned and won't be accessible by the customer.",
                    ...
                    "unassign-applications-text": "After the confirmation all selected applications will be unassigned and won't be accessible by the customer.",
