    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "dataModels": {
                    ...
                    "child-of":"Child Of",
                    "delete-parent-title":"Are you sure you want to delete '{{dataModelName}}'?",
                    "delete-child-title":"Are you sure you want to delete '{{dataModelName}}' ?<br/>" +
                                         "You would also be deleting '{{childDataModel}}'.",
                ...
                "device": {
                    ...
                    "add": "Add Device",
                    "assign-to-customer": "Assign to business unit",
                    "assign-to-datamodel": "Assign Datamodel Object",
                    "edit-assign-to-datamodel": "Edit Datamodel Object",
                    "assign-datamodelobject": "Datamodel Object",
                ...
                "privacy-policy":{
                      ...
                      "matter":" Your privacy is important to us, and so is being transparent about how we collect, use, and share information about you. This policy is intended to help you understand",
                      "para-1": "We at Hashmap (Hashmap, Inc. and our affiliates) are committed to protecting your privacy. This Privacy Policy applies to both our Websites (www.hashmapinc.com and www.tempuspetro.com) and our Tempus Petro Service (the Service). This Privacy Policy governs our data collection, processing and usage practices. It also describes your choices regarding use, access and correction of your personal information. If you do not agree with the data practices described in this Privacy Policy, you should not use the Websites or the Subscription Service. ",
                      "para-2": "We periodically update this Privacy Policy. We will post any privacy policy changes on this page and, if the changes are significant, we will provide a more prominent notice by sending you an email notification, or if you subscribe to the Service, through the Service website.",
                      "para-3": "While we will notify you of any material changes to this Privacy Policy, we encourage you to review this Privacy Policy periodically. We will also keep prior versions of this Privacy Policy in an archive for your review.",
                      "para-4": "If you have any questions about this Privacy Policy or our treatment of the information you provide us, please write to us by email at sysadmin@hashmapinc.com or by mail to Hashmap, inc., 1000 Holcomb Woods Pkwy, Building 100, Suite 118, Roswell, GA, USA, Attn: Privacy.",
                      "header-1": "Collection and Use of Personal Information ",
                      "header-1-matter-1": "If you use the Websites, personal information that identifies you as an individual or that relates to an identifiable person (“Personal Information”) may be collected and processed by Hashmap employees. In general, we collect and process Personal Information when you knowingly provide it to us, such as: ",
                      "name": "Name",
                      "company": "Company Name",
                      "job": "Job Title",
                      "address": "Postal address (including billing and shipping addresses)",
                      "operation": "Country of operation (may be different than office location)",
                      "number": "Telephone number",
                      "email":"Email address",
                      "header-1-matter-2": "We may need to collect and process these types of Personal Information in order to provide the Service to you, or because we are legally required to do so. If you do not provide the information that we request, we may not be able to provide you with the Service, including the following: ",
                      "toContact": "To contact you:",
                      "subList1": "To respond to your inquiries and fulfill your requests, such as modify your access to the Service.",
                      "subList2": "To send administrative information to you, for example, information regarding the Service and changes to our terms, conditions and policies.",
                      "toComply": "To comply with any agreements we may have entered into with you.",
                      "businessPurpose": "For our business purposes, such as data analysis, audits, fraud monitoring and prevention, developing new products, enhancing, improving or modifying our Services, identifying usage trends, determining the effectiveness of our communications processes and operating and expanding our business activities. ",
                      "header-1-matter-3": "Additionally, Hashmap may automatically collect or process Personal Information (such as your Internet domain or IP address) as part of the operation of the Websites or during the course of your activities on or use of the Websites.",
                      "header-2": "Sharing with other Hashmap companies ",
                      "header-2-matter": "We may share your Personal Information with our affiliates for the purposes described in this Statement. To the extent that these entities have access to your information, they will follow privacy practices no less protective than the practices described in this Statement, to the extent allowed by law.",
                      "header-3": "How Personal Information is shared with third parties",
                      "header-3-matter-1": "Hashmap may disclose Personal Information to third parties assisting us in carrying out a transaction or providing the Service for you (such as authentication, connecting to other data services, or performing statistical analyses of our Service). We may also disclose your Personal Information to our third party service providers who provide services such as website hosting, data analysis, payment processing, order fulfillment, information technology and related infrastructure provision, customer service, email delivery, auditing and other services. In addition, we may use, disclose or transfer your Personal Information to a third party in the event of any reorganization, merger, sale, joint venture, assignment, transfer or other disposition of all or any portion of our business (including in connection with any bankruptcy or similar proceedings). ",
                      "header-3-matter-2": "Other than with your consent, Hashmap will not sell, trade, or disclose your Personal Information to third parties that want to market products to you. ",
                      "header-4": "Other uses and disclosures",
                      "header-4-matter": "Hashmap may use or disclose Personal Information as we believe to be necessary or appropriate: (a) under applicable law, including laws outside your country of residence; (b) to comply with legal process; (c) to respond to requests from public and government authorities including public and government authorities outside your country of residence; (d) to enforce our terms and conditions or in response to activities that are unlawful or a violation of Hashmap rules for use of the Websites; (e) to protect our operations or those of any of our affiliates; (f) to protect our rights, privacy, safety or property, and/or that of our affiliates, you or others; and (g) to allow us to pursue available remedies or limit the damages that we may sustain.",
                      "header-5": "Sensitive Information",
                      "header-5-matter": "We do not knowingly collect sensitive Personal Information. Sensitive Personal Information refers to credit or debit card numbers, personal financial account information, Social Security numbers, passport numbers, driver's license numbers or similar personal identifiers, racial or ethnic origin, physical or mental health condition or information, or other employment, financial or health information. We ask that you not send us, and you not disclose to us, any sensitive Personal Information on or through the Websites or otherwise. ",
                      "header-6": "Other information we may collect, including ‘cookies’",
                      "header-6-matter-1": "“Other Information” is any information that does not reveal your specific identity or does not directly relate to an individual, such as:",
                      "header-6-list-1": "Browser and device information",
                      "header-6-list-2": "App usage data ",
                      "header-6-list-3": "Information collected through cookies, pixel tags and other technologies",
                      "header-6-list-4": "Demographic information and other information provided by you that does not reveal your specific identity",
                      "header-6-matter-2": "We and our service providers may collect Other Information in a variety of ways, including: ",
                      "header-6-sub-header-1": "Through your browser or device:",
                      "header-6-sub-matter-1": "Certain information is collected by most browsers or automatically through your device, such as your Media Access Control (MAC) address, computer type (Windows or Mac), screen resolution, operating system name and version, device manufacturer and model, language, Internet browser type and version and the name and version of the Services (such as the App) you are using. We use this information to ensure that the Services function properly. ",
                      "header-6-sub-header-2": "Use of cookies: ",
                      "header-6-sub-matter-2": " We may use 'cookies' in connection with operation of our Websites. Cookies are small pieces of information that are stored on your computer by the Hashmap Website server. Cookies are used for record-keeping purposes—the stored information about the browser type, pages visited, language preferences can be retrieved by the Hashmap Website server when you return to the Website. Much of the information we do collect is statistical only. We use this information about the number of visitors and their use of the sites in aggregate form to make our sites more useful and attractive to you.",
                      "header-6-para": "We may use and disclose Other Information for any purpose, except where we are required to do otherwise under applicable law. If we are required to treat Other Information as Personal Information under applicable law, then we may use and disclose it for the purposes for which we use and disclose Personal Information as detailed in this Policy. ",
                      "header-6-para-2": "In some instances, we may combine Other Information with Personal Information (such as combining your name with your geographical location). If we combine any Other Information with Personal Information, the combined information will be treated as Personal Information as long as it is combined.",
                      "header-14": "Security measures ",
                      "header-14-matter": "Hashmap uses a variety of security technologies and procedures to help protect your Personal Information from unauthorized access, use or disclosure. We secure the Personal Information you provide on computer servers in a controlled, secure environment, protected from unauthorized access, use or disclosure. All Personal Information is protected using appropriate physical, technical and organizational measures. ",
                      "header-7": "Modifications to Statement ",
                      "header-7-matter": "Hashmap reserves the right to change, modify, or update this Statement at any time. Your use of the Services following these changes means that you accept the revised Privacy Statement.",
                      "header-8": "Accessing and Controlling your Personal Information",
                      "header-8-para": "You have the following data protection rights:",
                      "header-8-list-1": "You can request access, correction, updates or deletion of your personal information. For your protection, we may need to verify your identity prior to making the requested changes.",
                      "header-8-list-2": "You can object to processing of your personal information, ask us to restrict processing of your personal information or request portability of your personal information.",
                      "header-8-list-3": "If we have collected and process your personal information with your consent, then you can withdraw your consent at any time. Withdrawing your consent will not affect the lawfulness of any processing we conducted prior to your withdrawal, nor will it affect processing of your personal information conducted in reliance on lawful processing grounds other than consent.",
                      "header-8-list-4": "You have the right to complain to a data protection authority about our collection and use of your personal information.",
                      "header-8-para-1": "Please note that we may need to retain certain information for recordkeeping purposes and/or to facilitate compliance with any agreements that you are a party to, you may not be able to change or delete the Personal Information provided in these cases. ",
                      "header-9": "Data retention ",
                      "header-9-matter": "Hashmap will not retain your Personal Information longer than is necessary and permitted in light of the purpose(s) for which it was obtained. The criteria used to determine our retention periods include: (i) the length of time we have an ongoing relationship with you; (ii) whether there is a legal obligation to which we are subject; or (iii) whether retention is advisable in light of our legal position (such as in regard to applicable statutes of limitations, litigation or regulatory investigations). ",
                      "header-10": "Children",
                      "header-10-matter": "Hashmap takes children's privacy seriously. The Websites are not intended for or targeted at children under eighteen (18) years of age, and we do not knowingly or intentionally collect information about children under 18 If you believe that we have collected information about a child under 18, please contact us at sysadmin@hashmapinc.com, so that we may delete the information.",
                      "header-11": "Jurisdiction and international transfer",
                      "header-11-matter": "In many cases your Personal Information may be collected or processed by, and transferred to, Hashmap facilities in the United States and in other countries where Hashmap does business. Your Personal Information may be stored and processed in any country where we have facilities or in which we engage service providers, and by using the Websites you consent to the transfer of information to countries outside of your country of residence, including the United States, which may have data protection rules that are different from those of your country. ",
                      "header-11-para": "This Privacy Policy shall apply even if we transfer Personal Information to other countries. We have taken appropriate safeguards to require that your Personal Information will remain protected. When we share information about you within and among our affiliated entities, we make use of standard contractual data protection clauses. When we transfer Personal Information to our service providers in other countries, we apply appropriate legal mechanisms to safeguard the transfer.",
                      "header-12": "External Websites",
                      "header-12-matter": "Our Websites may contain links to other websites. We do not control, and are not responsible for, the content or practices of these other websites. Our provision of such links does not constitute our endorsement of these other websites, their content, their owners, or their practices. This Privacy Policy does not apply to these other websites, which are subject to any privacy and other policies they may have.",
                      "header-13": "Contact information",
                      "header-13-matter": "Customers should direct comments or questions regarding this statement to sysadmin@hashmapinc.com. Because email communications are not always secure, please do not include credit card or other sensitive information in your emails to us.",
                      "header-13-para": "We may update and change any part or all of this Privacy Policy. If we update or change this Privacy Policy, the updated Privacy Policy will be posted at http://www.tempuspetro.com/legal/.  If you have a Tempus Petro subscription, we will we will let you know through the Tempus Petro website used to access your Tempus Petro subscription. If you do not have a Tempus Petro subscription, we will let you know by posting the revised copy on our website. The updated Privacy Policy will become effective and binding on the next business day after it is posted. When we change this Privacy Policy, the 'Last Modified' date above will be updated to reflect the date of the most recent version. We encourage you to review this Privacy Policy periodically. "
