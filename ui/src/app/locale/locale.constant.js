    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "computationJob": {
                    "computationJobs": "ComputationJobs",
                    "delete": "Delete ComputationJob",
                    "activate": "Activate ComputationJob",
                    "suspend": "Suspend ComputationJob",
                    "active": "Active",
                    "created": "Created",
                    "suspended": "Suspended",
                    "name": "Name",
                    "name-required": "Name is required.",
                    "description": "Description",
                    "add": "Add ComputationJob",
                    "delete-computationJob-title": "Are you sure you want to delete the computationJob '{{computationJobName}}'?",
                    ...
                    "delete-computationJobs-text": "Be careful, after the confirmation all selected computationJobs will be removed and all related data will become unrecoverable.",
                    "add-computationJob-text": "Add new computationJob",
                    "no-computationJobs-text": "No computationJobs found",
                    "computationJob-details": "computationJob details",
                    "api-token": "API token",
                    "api-token-required": "API token is required.",
                    "type": "Plugin type",
                    "type-required": "ComputationJob type is required.",
                    "configuration": "ComputationJob configuration",
                    "system": "System",
                    "select-computationJob": "Select computationJob",
                    "computationJob": "ComputationJob",
                    "no-computationJobs-matching": "No plugins matching '{{entity}}' were found.",
                    "ComputationJob-required": "ComputationJob is required.",
                    "ComputationJob-require-match": "Please select an existing computationJob.",
                    "events": "Events",
                    "details": "Details",
                    "import": "Import computationJob",
                    "export": "Export computationJob",
                    "export-failed-error": "Unable to export computationJob: {{error}}",
                    "create-new-computationJob": "Create new computationJob",
                    "computationJob-file": "ComputationJob file",
                    "invalid-computationJob-file-error": "Unable to import computationJob: Invalid computationJob data structure.",
                    "copyId": "Copy computationJob Id",
                    "idCopiedMessage": "ComputationJob Id has been copied to clipboard"
