...
public enum MsgType {
    ...
    POST_TELEMETRY_REQUEST(true), POST_TELEMETRY_REQUEST_DEPTH(true),STATUS_CODE_RESPONSE,
    SUBSCRIBE_SPARKPLUG_TELEMETRY_REQUEST, UNSUBSCRIBE_SPARKPLUG_TELEMETRY_REQUEST,
