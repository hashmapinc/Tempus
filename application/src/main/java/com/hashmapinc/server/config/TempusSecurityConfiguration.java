...
import com.hashmapinc.server.service.security.auth.jwt.*;
...
import com.hashmapinc.server.service.security.auth.rest.RestAuthenticationProvider;
import com.hashmapinc.server.service.security.auth.rest.RestLoginProcessingFilter;
import com.hashmapinc.server.service.security.auth.jwt.*;
import com.hashmapinc.server.service.security.auth.rest.RestPublicLoginProcessingFilter;
...
public class TempusSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private TempusErrorResponseHandler restAccessDeniedHandler;
