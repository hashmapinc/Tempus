...
public class SwaggerConfiguration {
      ...
      private ApiInfo apiInfo() {
            return new ApiInfoBuilder()
                .title("tempus REST API")
                .description("For instructions how to authorize requests please visit <a href='http://tempus.io/docs/reference/rest-api/'>REST API documentation page</a>.")
                .contact(new Contact("tempus team", "http://tempus.io", "info@tempus.io"))
                .license("Apache License Version 2.0")
                .licenseUrl("https://github.com/tempus/tempus/blob/master/LICENSE")
                .version("2.0")
                .build();
      }
