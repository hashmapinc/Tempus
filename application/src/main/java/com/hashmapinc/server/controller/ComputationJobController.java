...
import static com.hashmapinc.server.common.data.exception.TempusErrorCode.GENERAL;
...
public class ComputationJobController extends BaseController{
    ...
    public ComputationJob saveComputationJob(@PathVariable("computationid") String strComputationId,
        ...
        try {
            ...
            enrichComputationJob(source, computations);
    ...
    private void enrichComputationJob(@RequestBody ComputationJob source, Computations computations) {
