 ...
 */
package com.hashmapinc.server.service.install.sql;

import com.hashmapinc.server.service.install.DatabaseHelper;
...
public class SqlDbHelper {
    ...
    public static void loadTable(Connection conn, String tableName, String[] columns, Path sourceFile, boolean parseHeader) throws Exception {
        ...
        if (parseHeader) {
            ...
            csvFormat = DatabaseHelper.CSV_DUMP_FORMAT.withHeader(columns);
        }
